---
name: graphify
description: Turn any input (codebase, documentation, papers, images) into a navigable knowledge graph with clustered communities, interactive HTML visualization, GraphRAG JSON, and audit reports. Use when the user requests /graphify or asks to map and analyze project architectures and dependencies.
---
